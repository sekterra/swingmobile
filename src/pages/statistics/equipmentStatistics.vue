...
export default {
  ...
  beforeMount() {
    ...
    this.statusList = [
      ...
      {key: 'equipmentOfDowntime', searchYn: true},
      {key: 'maintenanceCost', searchYn: true},
      {key: 'mttr', searchYn: true},
      {key: 'mtbf', searchYn: true}
    ]
  ...
  methods: {
    ...
    dateChanged(_key) {
      ...
      param.key = _key;
      param.dateType = this.$refs[_key][0].dateType;
