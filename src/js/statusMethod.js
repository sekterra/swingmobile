  ...
  woPmCompleteStatus(_param) {
    ajax.url = selectConfig.woList[0].url
      ...
      ajax.requestGet((_result) => {
        ...
        statusData.key = _param.key
        statusData.data = {}
        statusData.data.woCompleteRate = comm.getPercentage(woCompleteArray.length, result.length);
